...
try:
    ...
    error("no pygame for pyconsole")
    frame.loader.abort_module_load()
...
cfg_path = "modules/core/pyconsole.txt"
...
class Console:
    ...
    def load_cfg(self):
        ...
        self.__dict__.update(frame.loader["pyconsole_config"])
    ...
    def draw(self):
        ...
        if self.changed:
            ...
            #print([-(self.max_lines+self.c_scroll),len(self.c_out)-self.c_scroll])
    ...
    def set_interpreter(self):
        if self.python_mode:
            ...
            self.python_interpreter = InteractiveConsole(self.__locals)
            self.tmp_fds = []
...
frame.modules["_pyconsole_Console"]=Console
